			...
			<div class="form-output">
				<form action="{{url('/admin/doregister')}}" method="post"  enctype="multipart/form-data">
					...
					<div class="form-group label-floating">
						...
						<input class="form-control" value="{{old('phone')}}"  name="phone" placeholder="" type="text">
					</div>
					
					<div class="form-group label-floating">
					<label class="control-label">Summary</label>
					<textarea class="form-control"   placeholder="write summary..." name="summary" id="exampleTextarea" style="height: 250px;">{{old('summary')}}</textarea>
				   </div>
				   <div class="form-group label-floating">
